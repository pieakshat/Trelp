...
/// @dev Vendored from Uniswap v4-periphery (MIT), unmodified apart from this note. Importing
///      v4-periphery directly makes solc load v4-core twice; see RangeMath for the detail.
/// @title HookMiner
